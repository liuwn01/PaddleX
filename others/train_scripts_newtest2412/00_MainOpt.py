...
if config.File_Prefix_ForVal:
    ...
    gil_run(st=replaced_txt_path,sl=config.Slides,c=config.Total_Records_Generate,pf=pf,ie=config.IsHasUnusualChars,wl_sc_ratio=config.Wordlist_SingleChars_Ratio)
