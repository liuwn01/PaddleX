...
pf = "phrase_01_aug_05_0100_add_sc_val"+datetime.datetime.now().strftime('_%Y%m%dT%H')
gen_enhance_txt(st=fc_txt,sl="1,2,3,5,7,11,13,17,19,23",c=per_line_generate_records,pf=pf,ie=isHasExceptionChars,wl_sc_ratio="0:100")

from gen_images import run as gi_run
gi_run(c=100000000,t=f"./output/{pf}.txt",pf=pf,fs="15,21",cc=16)